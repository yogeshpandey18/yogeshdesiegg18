...
<head>
  ...
  <style>
    * {margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, sans-serif;}
    ...
    form input, form textarea {width: 100%; padding: 10px; margin: 10px 0; border: 1px solid #ccc; border-radius: 10px;}
...
<body>
  ...
  <section id="contact">
    ...
    <form>
      ...
      <textarea placeholder="Your Message or Order Details"></textarea>
  ...
  <script>
    ...
    hiddenEls.forEach(el => observer.observe(el));public class Main {
